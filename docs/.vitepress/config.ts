...
export default defineConfig({
  title: 'RedStraw',
  description: "RedStraw is a tool for building type-safe data layer, turns Markdown/MDX, YAML, JSON, or other files into app's data layer with Zod schema.",
  lastUpdated: true,
  cleanUrls: true,
  head: [
    ...
    ['meta', { name: 'og:site_name', content: 'RedStraw' }],
    ['meta', { name: 'og:image', content: 'https://redstraw.js.org/redstraw-og.jpg' }]
  ],
  // locales: {
  ...
  themeConfig: {
    ...
    editLink: {
      ...
      pattern: 'https://github.com/ajmalleonard/redstraw/edit/main/docs/:path'
    },
    socialLinks: [{ icon: 'github', link: 'https://github.com/ajmalleonard/redstraw' }],
    footer: {
    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: 'RedStraw Schemas', link: 'redstraw-schemas' }
        ]
      },
      {
        text: 'Recipes',
      ...
      },
      {
        ...
        base: '/guide/',
        items: [
          { text: 'How RedStraw Works', link: 'how-it-works' },
