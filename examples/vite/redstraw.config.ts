...
// refer to https://tools.redstraw.squareexp.com/guide/last-modified#based-on-git-timestamp for more details
const timestamp = () =>
  s
...
export default defineConfig({
  ...
  prepare: ({ categories, tags, posts }) => {
    ...
    // return false // return false to prevent RedStraw from writing data to disk
  }
})