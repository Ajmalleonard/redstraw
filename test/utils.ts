...
describe('matchPatterns function', async t => {
  ...
  it('excludes files matching negated patterns', () => {
    strictEqual(matchPatterns('lib/secret.js', ['**/*.js', '!lib/**']), false)
    strictEqual(matchPatterns('src/app.js', ['**/*.js', '!lib/**']), true)
    strictEqual(matchPatterns('drafts/post.md', ['**/*.md', '!**/drafts/**']), false)
    strictEqual(matchPatterns('posts/post.md', ['**/*.md', '!**/drafts/**']), true)
  })
})
